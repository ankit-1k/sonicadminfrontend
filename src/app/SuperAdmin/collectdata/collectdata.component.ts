...
export class CollectdataComponent implements OnInit {
  ...
  constructor(
    ...
    private colllectDataService: CollectdataService
  ) {
  ...
  addOrUpdateData() {
    if (this.formData.valid) {
      ...
      if (this.editMode) {
        ...
        this.colllectDataService
          .updateCollectData(this.selectedData._id, this.formData.value)
          .subscribe({
            next: () => {
              Swal.fire({
                title: 'Updated',
        ...
        // Add new data
        this.colllectDataService
          .postCollectData(this.formData.value)
          .subscribe({
            next: () => {
              Swal.fire({
                title: 'Success',
